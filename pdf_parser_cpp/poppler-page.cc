...
//                XPDFReader::transform( MTX, lineann->getX2(), lineann->getY2(), p );
		...
		p.setY(lineann->getY2());
		    ...
		    qreal height = pageSizeF().height();
		    //@@!
		    quad.points[0].setX(hlquads->getX1(q));
		    quad.points[0].setY(hlquads->getY1(q));
		    quad.points[1].setX(hlquads->getX2(q));
		    quad.points[1].setY(hlquads->getY2(q));
		    quad.points[2].setX(hlquads->getX3(q));
		    quad.points[2].setY(hlquads->getY3(q));
		    quad.points[3].setX(hlquads->getX4(q));
		    quad.points[3].setY(hlquads->getY4(q));
//            std::cout<<hlquads->getX1(q)<<" " ;
//                     <<hlquads->getY1(q)<<std::endl;
//
//            std::cout<<hlquads->getX2(q)<<" " ;
//                     <<hlquads->getY2(q)<<std::endl;
//
//            std::cout<<hlquads->getX3(q)<<" " ;
//                     <<hlquads->getY3(q)<<std::endl;
//
//            std::cout<<hlquads->getX4(q)<<" " ;
//                     <<hlquads->getY4(q)<<std::endl;
