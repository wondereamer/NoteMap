...
def my_decode(string):
    '''make unicode'''
    encodings = [ "ascii", "utf_8", "gb2312", "gbk","big5", "big5hkscs", "cp037", "cp424", "cp437", "cp500", "cp737", "cp775", "cp850", "cp852", "cp855", 
        ...
        "euc_jp", "euc_jis_2004", "euc_jisx0213", "euc_kr",  "gb18030", "hz", "iso2022_jp", "iso2022_jp_1", "iso2022_jp_2", 
